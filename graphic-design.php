        ...
        <div class="row no-gutters">
            ...
            <div class="col-lg-4">
                <div class="hero__wrap">
                    ...
                    <p class="hero-subline">Connecting People Through Design</p>
                </div>
            </div>
        </div>
    </div>
    ...
    <div class="custom-container-wrap pt-0 pb-0">
        <div class="row align-items-center ">
            <div class="col-12 col-lg-10 col-xl-8 m-auto text-center">
                ...
                <p class="body-text-16 text-justify font-weight-normal mb-4">We don’t just do design. Our creative graphic design services are all about visual experiences that evoke emotions, push boundaries and exceed expectations.</p>
                <p class="body-text-16 text-justify font-weight-normal mb-4">Everyone knows it’s important to stand out from the crowd, but doing it is easier said than done when that crowd is getting busier and noisier every day. Luckily, the solution is right here at our fingertips.</p>
                <p class="body-text-16 text-justify font-weight-normal mb-4">We’re don’t offer your average graphic design business services. We know that great design requires understanding what makes a great user experience. It’s about using pictures, colours and fonts that speak to your audience and tell them what you’re about without having to shout about it. It’s about building trust, recognition and forging beautiful relationships that go on to stand the test of time. And it’s about clear, simple messaging that gets you where you want to be.</p>
            ...
            <div class="col-12 col-lg-10 col-xl-8 m-auto text-left">
                <h5 class="heading-5 text-center">Here’s why you need Graphic Design Services from Fire Up Design</h5>
                <ul>
