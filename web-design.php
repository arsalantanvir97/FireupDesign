...
<section class="hero">
    <div class="container-fluid p-0">
        <div class="row no-gutters">
            <div class="col-lg-8">
                <img src="images/web-banner.jpg" class="img-fluid hero-banner" alt="">
            </div>
            <div class="col-lg-4">
                <div class="hero__wrap">
                    ...
                    <p class="hero-subline">Our web design and development services delight and amaze</p>
                    <div class="d-flex hero-link">
                        <a href="wordpress-development.php" class="orange-link mr-4" style="opacity: 1;">WordPress<i class="fas fa-chevron-right ml-2"></i></a>
                        <a href="ecommerce-website-development.php" class="orange-link" style="opacity: 1;">eCommerce<i class="fas fa-chevron-right ml-2"></i></a>
                    </div>
    ...
    <div class="custom-container-wrap pt-0 pb-5">
        <div class="row align-items-center ">
            <div class="col-12 col-lg-10 col-xl-8 m-auto text-center">
                <h3 class="heading-3">Your Website, Your Story</h3>
                <p class="body-text-16 text-justify font-weight-normal mb-4">You already know you’re great at what you do. But how do you share that brilliance with the rest of the world, in an increasingly crowded and competitive environment? </p>
                <p class="body-text-16 text-justify font-weight-normal mb-3">The secret is to win their hearts and minds. </p>
                <p class="body-text-16 text-justify font-weight-normal mb-3">At Fire Up Design , we don’t just create websites. We tell stories, paint pictures and take visitors on journeys where brands come alive. We’re all about creating memorable experiences that turn into long term partnerships, because we know that no matter how far technology can take us, great business is all about people. So, if you’re looking for an affordable web design agency that really gets you, step this way….</p>
            </div>
            <div class="col-12 col-lg-10 col-xl-8 m-auto pt-4">
                <h5 class="heading-5 text-center">Hello, let’s create something beautiful</h5>
                <p class="body-text-16 text-justify font-weight-normal mb-3">You know you want a website, but here’s why you NEED FIRE-Up to create it for you:</p>
                <ul>
                ...
                <p class="body-text-16 text-justify font-weight-normal mb-3">We’re big on quality, but we also know that value for money is vital too. Sometimes, choosing an affordable web design agency means compromising on the end product, but that couldn’t be further from the truth with us. We strive for excellence in everything we do, so we’ll always deliver a great quality website at a cost you’ll be pleasantly surprised by.</p>
                <p class="body-text-16 text-justify font-weight-normal mb-3">Your business goals are always our number one priority, so you can trust to deliver a beautiful, user friendly website on time, within budget and with a smile. </p>
            </div>
        </div>
    </div>
</section>
            ...
            <div class="row">
                ...
                <div class="col-12 col-lg-6 mb-4 mb-lg-5 d-flex">
                    <div class="media project-steps">
                        ...
                        <div class="media-body">
                            <h5 class="mt-0"><span class="d-lg-block">Define</span>Strategy brand definition</h5>
                            <p class="body-text-16 font-weight-normal">This is where we start to dig a bit deeper into the things that define your brand, like the colours, styles and fonts that really speak to you and represent your personality.</p>
                        </div>
                    </div>
                </div>
                <div class="col-12 col-lg-6 mb-4 mb-lg-5 d-flex">
                    <div class="media project-steps">
                        ...
                        <div class="media-body">
                            ...
                            <p class="body-text-16 font-weight-normal">When we’ve got all the information we need, we’ll get to work on developing a prototype. This is where we get busy with developing user-friendly interfaces, wireframes and conducting tests to make sure everything’s working as it should.</p>
                        </div>
                    </div>
                </div>
                <div class="col-12 col-lg-6 mb-4 mb-lg-5 d-flex">
                    <div class="media project-steps">
                        ...
                        <div class="media-body">
                            ...
                            <p class="body-text-16 font-weight-normal">Now the magic really starts to happen. During this stage we’ll do our final tweaks, refine the details and roll out the design so it’s ready to go. All you need to do now is get ready for those calls and emails to start coming in.</p>
                        </div>
                    </div>
                </div>
            </div>
