...
<section class="hero">
    <div class="container-fluid p-0">
        <div class="row no-gutters">
            <div class="col-lg-8">
                <img src="images/ecommerce-banner.jpg" class="img-fluid hero-banner" alt="">
            </div>
            <div class="col-lg-4">
    ...
    <div class="custom-container-wrap pt-0 pb-5">
        <div class="row align-items-center ">
            <div class="col-12 col-lg-10 col-xl-8 m-auto">
                    ...
                    <table border="1" cellspacing="0" cellpadding="10" width="100%">
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td width="323" valign="top">
                                    <p class="body-text-16 text-justify font-weight-normal mb-0">These cookies are essential to provide you with services available through our website and to enable you to use some of its features. For example, they allow you to log in to secure areas of our website and help the content of the pages you request load quickly.<strong> </strong>Without these cookies, the services that you have asked for cannot be provided, and we only use these cookies to provide you with those services.</p>
                                </td>
                            </tr>
                            <tr>
                                <td width="145" valign="top">
                            ...
                            <tr>
                                ...
                                <td width="323" valign="top">
                                    ...
                                    <p>You can find out more about how Google protects your data here: <a href="https://policies.google.com/privacy">https://policies.google.com/privacy</a>.</p>
                                    <p>You can prevent the use of Google Analytics relating to your use of our website by downloading and installing the browser plugin available via this link: <a href="http://tools.google.com/dlpage/gaoptout?hl=en-GB">http://tools.google.com/dlpage/gaoptout?hl=en-GB</a><br></p>
                                </td>
                            </tr>
                            <tr>
                                <td width="145" valign="top">
                ...
                <h4 class="heading-4">Sharing Your Personal Data</h4>
                <p class="body-text-16 text-justify font-weight-normal mb-3">We may share your personal data as follows:</p>
                <ul>
...
<section id="lets-connect" class="content-body pb-extra pt-4">
