...
<head>
    ...
    <title>Fire Up Design - <?php echo ((isset($title)) ? $title : 'Home'); ?></title>
</head>
            ...
            <div class="wrapper">
                ...
                <div class="serviceCard">
                    <a href="social-media-marketing.php">
                        <div class="inner-w">
                            <div class="sc-top">
                                <img src="images/service-d-2.jpg" class="img-fluid" alt="">
                            </div>
                            <div class="sc-bot">
                                <h5 class="sc-title">Search engine Optimization</h5>
                                <p class="sc-excerpt">Let us design your mobile app so that your business can stay ahead of the pack...</p>
                            </div>
                        </div>
                    </a>
                </div>
