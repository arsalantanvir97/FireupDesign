    ...
    <div class="custom-container-wrap pt-0 pb-5">
        <div class="row align-items-center ">
            <div class="col-12 col-lg-10 col-xl-8 m-auto text-center">
                <h3 class="heading-3"> Stories behind design balanace artist</h3>
                <p class="body-text-16 text-justify font-weight-light mb-0">Lorem Ipsum is simply dummy text of the printing and typesetting industry. Lorem Ipsum has been the industry's standard dummy text ever since the when an unknown printer took a galley of type and scrambled it to make a type specimen book. It has survived not only five centuries, but also the leap into electronic typesetting, remaining essentially unchanged. It was popularised in the with the release of Letraset sheets containing Lorem Ipsum passages, and more recently with desktop publishing software like Aldus PageMaker including versions of Lorem Ipsum.</p>
            </div>
        </div>
    </div>
</section>
    ...
    <div class="custom-container-wrap">
        ...
        <div class="row fade-in">
            ...
            <div class="col-12 col-lg-4 d-flex mb-4 mb-lg-0">
                <div class="techno-info-box text-center">
