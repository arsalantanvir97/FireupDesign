    ...
    <div class="custom-container-wrap pt-0 pb-5">
        <div class="row align-items-center ">
            <div class="col-12 col-lg-10 col-xl-8 m-auto">
                ...
                <h4 class="heading-4">Privacy Policy</h4>
                <p class="body-text-16 text-justify font-weight-normal mb-3">
                ...
                <h4 class="heading-4">Your Account</h4>
                <p class="body-text-16 text-justify font-weight-normal mb-3">
                ...
                <h4 class="heading-4">Services</h4>
                <p class="body-text-16 text-justify font-weight-normal mb-3">
                ...
                <h4 class="heading-4">Third Party Services</h4>
                <p class="body-text-16 text-justify font-weight-normal mb-3">
                ...
                <h4 class="heading-4">Prohibited Uses and Intellectual Property</h4>
                <p class="body-text-16 text-justify font-weight-normal mb-3">
                ...
                <h4 class="heading-4">The Company Materials</h4>
                <p class="body-text-16 text-justify font-weight-normal mb-3">
                ...
                <p class="body-text-16 text-justify font-weight-normal mb-3">By posting, uploading, inputting, providing or submitting your Content you warrant and represent that you own all of the rights to your Content.</p>

                <h4 class="heading-4">Disclaimer of Certain Liabilities</h4>
                <p class="body-text-16 text-justify font-weight-normal mb-3">
                ...
                <h4 class="heading-4">Indemnification</h4>
                <p class="body-text-16 text-justify font-weight-normal mb-3">
