...
<section class="hero">
    <div class="container-fluid p-0">
        <div class="row no-gutters">
            <div class="col-lg-8">
                <img src="images/blog-banner.jpg" class="img-fluid hero-banner" alt="">
            </div>
            <div class="col-lg-4">
            ...
            <div class="col-12 col-lg-10 m-auto">
                <div class="row">
                    <div class="col-12 text-center pb-4">
                        <h3 class="heading-3">Our blog</h3>
                        <p class="body-text-18 font-weight-bold">Some of our blog posts</p>
                    </div>
                    <div class="col-12">
                        <div class="post-card bg-white">
                            <div class="card-header">
                                <div class="position-relative">
                                    <img src="images/post-1.jpg" class="img-fluid w-100 h-100 " alt="">
                                    <div class="post-tag">
                                        <span class="date d-block">20</span>
                                        <span class="month d-block">Oct</span>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="card-footer text-center text-lg-right p-0">
                                <ul class="social bg-white d-inline-flex justify-content-center justify-content-lg-end px-3 position-relative z-inxed-1">
                                    <li>
                        ...
                        <div class="post-card bg-white">
                            <div class="card-header">
                                <div class="position-relative">
                                    <img src="images/post-2.jpg" class="img-fluid w-100 h-100 " alt="">
                                    <div class="post-tag">
                                        <span class="date d-block">20</span>
                                        <span class="month d-block">Oct</span>
                                    </div>
                            ...
                            <div class="card-header">
                                <div class="position-relative">
                                    <div class="post-video">
                                        <video width="100%" height="515" poster="images/post-3.jpg" controls="">
